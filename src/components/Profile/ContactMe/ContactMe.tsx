...
export default function ContactMe() {
  return (
    <section className="flex py-3 px-6">
      <div>
        <h2 className="text-2xl font-bold mb-3 ml-0.5 sm:text-3xl lg:text-4xl">
        ...
        <div className="flex mt-5 gap-6">
          <a
            ...
            className="group text-4xl transition-transform transform hover:scale-110"
          >
            <FaGithub />
          ...
          <a
            ...
            className="group text-5xl -mt-1.5 transition-transform transform hover:scale-110"
          >
            <HiOutlineMail />
            <span className="absolute left-1/2 -bottom-6 transform -translate-x-1/2 px-2 py-1 bg-white dark:bg-gray-800 text-black dark:text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
